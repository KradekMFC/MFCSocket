...
function JoinChannelMessage(sessionId, broadcasterId) {
    ...
    return new MFCMessage({ Type: MessageType.FCTYPE_JOINCHAN, From: sessionId, To: 0, Arg1: publicChannelId, Arg2: MFCChatOpt.FCCHAN_JOIN });
}

//shortcut class for join channel
function LeaveChannelMessage(sessionId, broadcasterId) {
    var publicChannelId = 100000000 + broadcasterId;
    return new MFCMessage({ Type: MessageType.FCTYPE_JOINCHAN, From: sessionId, To: 0, Arg1: publicChannelId, Arg2: MFCChatOpt.FCCHAN_PART });
}

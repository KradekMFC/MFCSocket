...
function MFCSocket(name, passCode) {
    ...
    function onSocketMessage(msg){
        if (!msg.data instanceof Blob){ //make sure the received websocket message is text (not a binary blob)
            var mfcMessageQueue = msg.data; //websocket messages are always complete and don't need to be reconstructed/buffered
